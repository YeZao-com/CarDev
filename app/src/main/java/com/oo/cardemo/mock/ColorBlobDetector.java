...
public class ColorBlobDetector implements IDetector {
   ...
   private Scalar CONTOUR_COLOR =new  Scalar(255,0,0,255);
    ...
    public void process(@Nullable Mat rgbaImage, @Nullable List<? extends Color> colors) {
        ...
        Mat colorLabel = rgbaImage.submat(4, 68, 4, 68);
//        colorLabel.setTo(mBlobColorRgba);mBlobColorRgba
        Mat spectrumLabel = rgbaImage.submat(4, 4 + mSpectrum.rows(), 70, 70 + mSpectrum.cols());
